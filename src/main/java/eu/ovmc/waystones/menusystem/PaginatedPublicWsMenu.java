...
public abstract class PaginatedPublicWsMenu extends Menu {
    ...
    public PaginatedPublicWsMenu(PlayerMenuUtility playerMenuUtility, int startingPage, int prevIndexWs) {
        super(playerMenuUtility);
        this.startingPage = startingPage;
        this.prevIndexWs = prevIndexWs;
